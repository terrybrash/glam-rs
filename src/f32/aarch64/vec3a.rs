...
use crate::{aarch64::*, f32::math, BVec3, BVec3A, FloatExt, Quat, Vec2, Vec3, Vec4};
...
impl Vec3A {
    ...
    /// Vec3A uses Arm NEON
    pub const USES_AARCH64: bool = true;
    ...
    pub fn cross(self, rhs: Self) -> Self {
        unsafe {
            ...
            // FMA: the subtracted product is the fused one, as on x86-64.
    ...
    pub fn min(self, rhs: Self) -> Self {
        Self(unsafe { vbslq_f32(vcltq_f32(self.0, rhs.0), self.0, rhs.0) })
    }
    ...
    pub fn max(self, rhs: Self) -> Self {
        Self(unsafe { vbslq_f32(vcgtq_f32(self.0, rhs.0), self.0, rhs.0) })
    }
    ...
    pub fn min_element(self) -> f32 {
        ...
        min(min(self.x, self.z), min(self.y, self.z))
    }
    ...
    pub fn max_element(self) -> f32 {
        ...
        max(max(self.x, self.z), max(self.y, self.z))
    }
