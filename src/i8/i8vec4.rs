...
impl I8Vec4 {
    ...
    #[cfg(all(target_arch = "aarch64", not(feature = "scalar-math")))]
    #[inline(always)]
    fn to_v(self) -> int8x8_t {
        let bits: u32 = unsafe { core::mem::transmute(self) };
        unsafe { vreinterpret_s8_u32(vdup_n_u32(bits)) }
    }

    #[cfg(all(target_arch = "aarch64", not(feature = "scalar-math")))]
    #[inline(always)]
    fn from_v(v: int8x8_t) -> Self {
        let bits = unsafe { vget_lane_u32::<0>(vreinterpret_u32_s8(v)) };
    ...
    pub fn min(self, rhs: Self) -> Self {
        #[cfg(all(target_arch = "aarch64", not(feature = "scalar-math")))]
        {
            Self::from_v(unsafe { vmin_s8(self.to_v(), rhs.to_v()) })
        }
        #[cfg(all(target_arch = "x86_64", not(feature = "scalar-math")))]
        {
            Self::from_v(unsafe { _mm_min_epi8(self.to_v(), rhs.to_v()) })
        }
        #[cfg(not(all(
    ...
    pub fn max(self, rhs: Self) -> Self {
        #[cfg(all(target_arch = "aarch64", not(feature = "scalar-math")))]
        {
            Self::from_v(unsafe { vmax_s8(self.to_v(), rhs.to_v()) })
        }
        #[cfg(all(target_arch = "x86_64", not(feature = "scalar-math")))]
        {
            Self::from_v(unsafe { _mm_max_epi8(self.to_v(), rhs.to_v()) })
        }
        #[cfg(not(all(
            any(target_arch = "aarch64", target_arch = "x86_64"),
            not(feature = "scalar-math")
    ...
    pub fn abs(self) -> Self {
        ...
        {
            Self::from_v(unsafe { vabs_s8(self.to_v()) })
        }
        #[cfg(all(
            target_arch = "x86_64",
            not(feature = "scalar-math"),
        ...
        {
            Self::from_v(unsafe { _mm_abs_epi8(self.to_v()) })
        }
        #[cfg(not(all(
            any(target_arch = "aarch64", target_arch = "x86_64"),
            not(feature = "scalar-math"),
